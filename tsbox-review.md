...
```
    ...
    ## • NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────────────────────────────────────────────
    ## * using log directory ‘/tmp/RtmpXTyu19/tsbox.Rcheck’
    ...
    ## Status: 1 NOTE
    ## See
    ##   ‘/tmp/RtmpXTyu19/tsbox.Rcheck/00check.log’
    ## for details.
...
```
    ...
    ## ✔ |         2 | nyc_flights [0.9s]                                                                                      
    ## 
    ## ⠸ [ FAIL 0 | WARN 0 | SKIP 0 | PASS 307 ] @ object_conversion                                                           
    ## ⠼ [ FAIL 0 | WARN 0 | SKIP 0 | PASS 308 ] @ object_conversion                                                           
    ...
    ## ✔ |         2 | readme [6.6s]                                                                                           
    ## 
    ## ⠋ [ FAIL 0 | WARN 0 | SKIP 0 | PASS 565 ] @ subannual                                                                   
    ## ⠙ [ FAIL 0 | WARN 0 | SKIP 0 | PASS 566 ] @ subannual                                                                   
    ##                                                                                                                         
    ## ✔ |       180 | subannual [2.8s]                                                                                        
    ## 
    ## ⠹ [ FAIL 0 | WARN 0 | SKIP 0 | PASS 586 ] @ time_conversion                                                             
    ##                                                                                                                         
    ## ✔ |        12 | time_conversion [0.1s]                                                                                  
    ## 
    ## ⠸ [ FAIL 0 | WARN 0 | SKIP 0 | PASS 587 ] Starting up...                                                                
    ...
    ## ⠋ [ FAIL 0 | WARN 0 | SKIP 0 | PASS 630 ] @ ts_chain                                                                    
    ## ⠙ [ FAIL 0 | WARN 0 | SKIP 0 | PASS 631 ] @ ts_chain, ts_first_of_period                                                
    ##                                                                                                                         
    ## ✔ |         3 | ts_chain [0.3s]                                                                                         
    ## 
    ...
    ## 
    ## ⠋ [ FAIL 0 | WARN 0 | SKIP 0 | PASS 651 ] @ ts_index                                                                    
    ...
    ## ⠼ [ FAIL 0 | WARN 0 | SKIP 0 | PASS 670 ] @ ts_lag                                                                      
    ## ⠴ [ FAIL 0 | WARN 0 | SKIP 0 | PASS 675 ] @ ts_lag, ts_long_wide                                                        
    ##                                                                                                                         
    ## ✔ |        12 | ts_lag [1.0s]                                                                                           
    ## 
    ...
    ## ✔ |         6 | ts_long_wide [0.4s]                                                                                     
    ## 
    ## ⠏ [ FAIL 0 | WARN 0 | SKIP 0 | PASS 681 ] @ ts_na_omit                                                                  
    ## ⠋ [ FAIL 0 | WARN 0 | SKIP 0 | PASS 681 ] @ ts_na_omit                                                                  
    ##                                                                                                                         
    ## ✔ |         3 | ts_na_omit [0.1s]                                                                                       
    ## 
    ## ⠙ [ FAIL 0 | WARN 0 | SKIP 0 | PASS 682 ] @ ts_pc, ts_pick                                                              
    ##                                                                                                                         
    ## ✔ |         4 | ts_pick [0.2s]                                                                                          
    ## 
    ...
    ## ✔ |         7 | ts_regular [0.2s]                                                                                       
    ## 
    ## ⠦ [ FAIL 0 | WARN 0 | SKIP 0 | PASS 697 ] @ ts_pc                                                                       
    ## ⠧ [ FAIL 0 | WARN 0 | SKIP 0 | PASS 697 ] @ ts_pc                                                                       
    ##                                                                                                                         
    ## ✔ |         2 | ts_scale                                                                                                
    ## 
    ## ⠇ [ FAIL 0 | WARN 0 | SKIP 0 | PASS 700 ] @ ts_pc                                                                       
    ## ⠏ [ FAIL 0 | WARN 0 | SKIP 0 | PASS 700 ] @ ts_pc                                                                       
    ## ⠋ [ FAIL 0 | WARN 0 | SKIP 0 | PASS 703 ] @ ts_pc, ts_span                                                              
